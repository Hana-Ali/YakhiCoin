...
import HamNavLinksGray from "./HamNavLinksGray";
// Importing the login
...
function NavBarGray(props) {
    ...
    return(
        <nav className={navbarClasses.join(" ")} style={{ "zIndex": "9999", "backgroundColor":"#F9F9FB" }}>
